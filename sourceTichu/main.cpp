...
int main(){
    ...
    // Print score
    points1 += game->getTeamPoints(0);
    points2 += game->getTeamPoints(1);
    cout << endl << "Score: " << endl;
    cout << players[0]->getName() << " and " << players[2]->getName() << " - " << points1 << endl;
    cout << players[1]->getName() << " and " << players[3]->getName() << " - " << points2 << endl;
